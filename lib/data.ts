...
export const products: Product[] = [
  ...
  },
  {
    ...
    price: 4.50,
    image: "/images/red_velvet_cookie.png",
    images: ["/images/red_velvet_cookie.png"],
    badges: ["new", "seasonal"],
    description: "A velvety red cocoa cookie studded with white chocolate chips and drizzled with tangy cream cheese icing.",
  },
  {
    id: "sc1",
    ...
    price: 4.75,
    image: "/images/salted_caramel_pretzel_cookie.png",
    images: ["/images/salted_caramel_pretzel_cookie.png"],
    badges: ["best-seller"],
    description: "Sweet and salty perfection. A golden cookie loaded with pretzel pieces and oozing caramel, finished with sea salt.",
  },
  {
    id: "lc1",
    slug: "lemon-crinkle",
    name: "Lemon Crinkle",
    price: 4.00,
    image: "/images/lemon_crinkle_cookie.png",
    images: ["/images/lemon_crinkle_cookie.png"],
    badges: ["seasonal"],
    description: "A burst of sunshine. Soft, zesty lemon cookie rolled in powdered sugar for that classic crinkle look.",
  },
  {
    id: "dc1",
    ...
    price: 4.50,
    image: "/images/double_chocolate_fudge_cookie.png",
    images: ["/images/double_chocolate_fudge_cookie.png"],
    badges: ["best-seller"],
    description: "For the serious chocolate lover. Dark chocolate dough packed with semi-sweet chunks and a molten fudge center.",
  },
  {
    id: "or1",
    slug: "oatmeal-raisin-walnut",
    name: "Oatmeal Raisin Walnut",
    price: 4.25,
    image: "/images/classic-vanilla-sugar.jpg",
    images: ["/images/classic-vanilla-sugar.jpg"],
    badges: ["best-seller"],
    description: "Like grandma used to make. Chewy oats, plump raisins, and crunchy walnuts with a hint of cinnamon.",
  },
];
