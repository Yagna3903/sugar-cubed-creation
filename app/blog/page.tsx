  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-brand-cream/30 via-white to-brand-pink/10">
      ...
      <section className="mx-auto max-w-7xl px-6 pb-20 pt-8">
        ...
        {posts.length === 0 ? (
          <div className="text-center py-20 bg-white rounded-3xl shadow-sm border border-brand-brown/5">
            <p className="text-zinc-500 text-lg">No stories yet. Check back soon!</p>
          </div>
        ) : (
                ...
                <div className="relative aspect-[4/3] overflow-hidden bg-zinc-100">
                  {p.coverImage ? (
                    ...
                    <div className="absolute inset-0 flex items-center justify-center text-zinc-300">
                      <IconSparkle className="w-12 h-12" />
                    </div>
                  )}
