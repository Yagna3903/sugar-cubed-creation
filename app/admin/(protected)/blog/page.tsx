...
export default async function BlogAdminPage() {
    ...
    return (
        <div className="mx-auto max-w-5xl p-4 sm:p-8">
            ...
            <div className="mt-8 rounded-3xl border border-brand-brown/5 bg-white shadow-soft overflow-hidden min-h-[75vh]">
                <div className="overflow-x-auto">
                    <table className="w-full text-left text-sm min-w-[600px]">
                        <thead className="bg-zinc-50 text-zinc-500">
                            <tr>
                                <th className="px-6 py-8 font-medium">Title</th>
                                <th className="px-6 py-8 font-medium">Status</th>
                                <th className="px-6 py-8 font-medium">Date</th>
                                <th className="px-6 py-8 font-medium text-right">Actions</th>
                            </tr>
                        </thead>
                            ...
                            {posts.length === 0 ? (
                                ...
                                posts.map((post) => (
                                    <tr key={post.id} className="group hover:bg-zinc-50/50">
                                        <td className="px-6 py-8 font-medium text-brand-brown">
                                            {post.title}
                                        ...
                                        <td className="px-6 py-8 text-zinc-500">
