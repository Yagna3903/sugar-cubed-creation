    ...
    <div className="mx-auto max-w-4xl">
      ...
      <div className="mt-4 grid gap-4 sm:grid-cols-3">
        ...
        <div className="rounded-2xl border bg-white p-4">
          ...
          >
            <div className="text-xs text-zinc-500 mb-2">Email Actions</div>
            <button className="w-full rounded-xl border border-zinc-200 bg-zinc-50 px-3 py-1.5 text-sm text-zinc-700 hover:bg-zinc-100 transition-colors flex items-center justify-center gap-2">
