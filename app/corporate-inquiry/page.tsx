  ...
  return (
    <section className="mx-auto max-w-3xl px-6 py-12">
      ...
      >
        ...
        <textarea
          name="cookie" // ← same name, no backend change
          placeholder="Describe the cookie: shape/size, colors, logo/text, quantity, event date…"
          className="mt-2 w-full rounded-2xl border border-neutral-200 bg-white px-5 py-4 text-[15px] shadow-card placeholder:text-neutral-400 focus:border-sugar-300 focus:ring-2 focus:ring-sugar-200 outline-none"
          rows={4}
        />
